...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute left-4 top-4 rounded-xl p-1 text-slate-400 opacity-70 ring-offset-slate-950 transition-opacity hover:opacity-100 hover:text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 disabled:pointer-events-none">
        <X className="h-4 w-4" />
