  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      {isModalOpen && (
        ...
        >
          <div 
            className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 sm:p-8 space-y-6 shadow-2xl cursor-default"
            onClick={(e) => e.stopPropagation()}
          >
